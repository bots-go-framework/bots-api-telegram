...
const (
	...
	ffjtAudioConfigProtectContent

	ffjtAudioConfigMessageThreadID

	ffjtAudioConfigMessageEffectID

	ffjtAudioConfigAllowPaidBroadcast

	ffjtAudioConfigReplyParameters
)
...
var ffjKeyAudioConfigProtectContent = []byte("protect_content")

var ffjKeyAudioConfigMessageThreadID = []byte("message_thread_id")

var ffjKeyAudioConfigMessageEffectID = []byte("message_effect_id")

var ffjKeyAudioConfigAllowPaidBroadcast = []byte("allow_paid_broadcast")

var ffjKeyAudioConfigReplyParameters = []byte("reply_parameters")
	...
	for {
		...
		case fflib.FFParse_want_key:
			...
			if len(kn) <= 0 {
				...
				case 'a':
					...
					if bytes.Equal(ffjKeyAudioConfigAllowPaidBroadcast, kn) {
						currentKey = ffjtAudioConfigAllowPaidBroadcast
						state = fflib.FFParse_want_colon
						goto mainparse
					}
				...
				case 'm':
					...
					if bytes.Equal(ffjKeyAudioConfigMessageThreadID, kn) {
						currentKey = ffjtAudioConfigMessageThreadID
						state = fflib.FFParse_want_colon
						goto mainparse

					} else if bytes.Equal(ffjKeyAudioConfigMessageEffectID, kn) {
						currentKey = ffjtAudioConfigMessageEffectID
						state = fflib.FFParse_want_colon
						goto mainparse
					}
				...
				case 'p':
					...
					if bytes.Equal(ffjKeyAudioConfigProtectContent, kn) {
						currentKey = ffjtAudioConfigProtectContent
						state = fflib.FFParse_want_colon
						goto mainparse
					}
				...
				case 'r':
					...
					} else if bytes.Equal(ffjKeyAudioConfigReplyParameters, kn) {
						currentKey = ffjtAudioConfigReplyParameters
						state = fflib.FFParse_want_colon
						goto mainparse
					}
				...
				if fflib.EqualFoldRight(ffjKeyAudioConfigReplyParameters, kn) {
					currentKey = ffjtAudioConfigReplyParameters
					state = fflib.FFParse_want_colon
					goto mainparse
				}

				if fflib.EqualFoldRight(ffjKeyAudioConfigAllowPaidBroadcast, kn) {
					currentKey = ffjtAudioConfigAllowPaidBroadcast
					state = fflib.FFParse_want_colon
					goto mainparse
				}

				if fflib.EqualFoldRight(ffjKeyAudioConfigMessageEffectID, kn) {
					currentKey = ffjtAudioConfigMessageEffectID
					state = fflib.FFParse_want_colon
					goto mainparse
				}

				if fflib.EqualFoldRight(ffjKeyAudioConfigMessageThreadID, kn) {
					currentKey = ffjtAudioConfigMessageThreadID
					state = fflib.FFParse_want_colon
					goto mainparse
				}

				if fflib.AsciiEqualFold(ffjKeyAudioConfigProtectContent, kn) {
					currentKey = ffjtAudioConfigProtectContent
					state = fflib.FFParse_want_colon
					goto mainparse
				}
		...
		case fflib.FFParse_want_value:
			...
			if tok == fflib.FFTok_left_brace || tok == fflib.FFTok_left_bracket || tok == fflib.FFTok_integer || tok == fflib.FFTok_double || tok == fflib.FFTok_string || tok == fflib.FFTok_bool || tok == fflib.FFTok_null {
				...
				case ffjtAudioConfigProtectContent:
					goto handle_ProtectContent

				case ffjtAudioConfigMessageThreadID:
					goto handle_MessageThreadID

				case ffjtAudioConfigMessageEffectID:
					goto handle_MessageEffectID

				case ffjtAudioConfigAllowPaidBroadcast:
					goto handle_AllowPaidBroadcast

				case ffjtAudioConfigReplyParameters:
...
const (
	...
	ffjtBaseChatProtectContent

	ffjtBaseChatMessageThreadID

	ffjtBaseChatMessageEffectID

	ffjtBaseChatAllowPaidBroadcast

	ffjtBaseChatReplyParameters
)
...
var ffjKeyBaseChatProtectContent = []byte("protect_content")

var ffjKeyBaseChatMessageThreadID = []byte("message_thread_id")

var ffjKeyBaseChatMessageEffectID = []byte("message_effect_id")

var ffjKeyBaseChatAllowPaidBroadcast = []byte("allow_paid_broadcast")

var ffjKeyBaseChatReplyParameters = []byte("reply_parameters")
	...
	for {
		...
		case fflib.FFParse_want_key:
			...
			if len(kn) <= 0 {
				...
				case 'a':
					...
					if bytes.Equal(ffjKeyBaseChatAllowPaidBroadcast, kn) {
						currentKey = ffjtBaseChatAllowPaidBroadcast
						state = fflib.FFParse_want_colon
						goto mainparse
					}
				...
				case 'm':
					...
					if bytes.Equal(ffjKeyBaseChatMessageThreadID, kn) {
						currentKey = ffjtBaseChatMessageThreadID
						state = fflib.FFParse_want_colon
						goto mainparse

					} else if bytes.Equal(ffjKeyBaseChatMessageEffectID, kn) {
						currentKey = ffjtBaseChatMessageEffectID
						state = fflib.FFParse_want_colon
						goto mainparse
					}
				...
				case 'p':
					...
					if bytes.Equal(ffjKeyBaseChatProtectContent, kn) {
						currentKey = ffjtBaseChatProtectContent
						state = fflib.FFParse_want_colon
						goto mainparse
					}
				...
				case 'r':
					...
					} else if bytes.Equal(ffjKeyBaseChatReplyParameters, kn) {
						currentKey = ffjtBaseChatReplyParameters
						state = fflib.FFParse_want_colon
						goto mainparse
					}
				...
				if fflib.EqualFoldRight(ffjKeyBaseChatReplyParameters, kn) {
					currentKey = ffjtBaseChatReplyParameters
					state = fflib.FFParse_want_colon
					goto mainparse
				}

				if fflib.EqualFoldRight(ffjKeyBaseChatAllowPaidBroadcast, kn) {
					currentKey = ffjtBaseChatAllowPaidBroadcast
					state = fflib.FFParse_want_colon
					goto mainparse
				}

				if fflib.EqualFoldRight(ffjKeyBaseChatMessageEffectID, kn) {
					currentKey = ffjtBaseChatMessageEffectID
					state = fflib.FFParse_want_colon
					goto mainparse
				}

				if fflib.EqualFoldRight(ffjKeyBaseChatMessageThreadID, kn) {
					currentKey = ffjtBaseChatMessageThreadID
					state = fflib.FFParse_want_colon
					goto mainparse
				}

				if fflib.AsciiEqualFold(ffjKeyBaseChatProtectContent, kn) {
					currentKey = ffjtBaseChatProtectContent
					state = fflib.FFParse_want_colon
					goto mainparse
				}
		...
		case fflib.FFParse_want_value:
			...
			if tok == fflib.FFTok_left_brace || tok == fflib.FFTok_left_bracket || tok == fflib.FFTok_integer || tok == fflib.FFTok_double || tok == fflib.FFTok_string || tok == fflib.FFTok_bool || tok == fflib.FFTok_null {
				...
				case ffjtBaseChatProtectContent:
					goto handle_ProtectContent

				case ffjtBaseChatMessageThreadID:
					goto handle_MessageThreadID

				case ffjtBaseChatMessageEffectID:
					goto handle_MessageEffectID

				case ffjtBaseChatAllowPaidBroadcast:
					goto handle_AllowPaidBroadcast

				case ffjtBaseChatReplyParameters:
					goto handle_ReplyParameters
...
const (
	...
	ffjtBaseFileProtectContent

	ffjtBaseFileMessageThreadID

	ffjtBaseFileMessageEffectID

	ffjtBaseFileAllowPaidBroadcast

	ffjtBaseFileReplyParameters
)
...
var ffjKeyBaseFileProtectContent = []byte("protect_content")

var ffjKeyBaseFileMessageThreadID = []byte("message_thread_id")

var ffjKeyBaseFileMessageEffectID = []byte("message_effect_id")

var ffjKeyBaseFileAllowPaidBroadcast = []byte("allow_paid_broadcast")

var ffjKeyBaseFileReplyParameters = []byte("reply_parameters")
	...
	for {
		...
		case fflib.FFParse_want_key:
			...
			if len(kn) <= 0 {
				...
				case 'a':
					...
					if bytes.Equal(ffjKeyBaseFileAllowPaidBroadcast, kn) {
						currentKey = ffjtBaseFileAllowPaidBroadcast
						state = fflib.FFParse_want_colon
						goto mainparse
					}
				...
				case 'm':
					...
					if bytes.Equal(ffjKeyBaseFileMessageThreadID, kn) {
						currentKey = ffjtBaseFileMessageThreadID
						state = fflib.FFParse_want_colon
						goto mainparse

					} else if bytes.Equal(ffjKeyBaseFileMessageEffectID, kn) {
						currentKey = ffjtBaseFileMessageEffectID
						state = fflib.FFParse_want_colon
						goto mainparse
					}
				...
				case 'p':
					...
					if bytes.Equal(ffjKeyBaseFileProtectContent, kn) {
						currentKey = ffjtBaseFileProtectContent
						state = fflib.FFParse_want_colon
						goto mainparse
					}
				...
				case 'r':
					...
					} else if bytes.Equal(ffjKeyBaseFileReplyParameters, kn) {
						currentKey = ffjtBaseFileReplyParameters
						state = fflib.FFParse_want_colon
						goto mainparse
					}
				...
				if fflib.EqualFoldRight(ffjKeyBaseFileReplyParameters, kn) {
					currentKey = ffjtBaseFileReplyParameters
					state = fflib.FFParse_want_colon
					goto mainparse
				}

				if fflib.EqualFoldRight(ffjKeyBaseFileAllowPaidBroadcast, kn) {
					currentKey = ffjtBaseFileAllowPaidBroadcast
					state = fflib.FFParse_want_colon
					goto mainparse
				}

				if fflib.EqualFoldRight(ffjKeyBaseFileMessageEffectID, kn) {
					currentKey = ffjtBaseFileMessageEffectID
					state = fflib.FFParse_want_colon
					goto mainparse
				}

				if fflib.EqualFoldRight(ffjKeyBaseFileMessageThreadID, kn) {
					currentKey = ffjtBaseFileMessageThreadID
					state = fflib.FFParse_want_colon
					goto mainparse
				}

				if fflib.AsciiEqualFold(ffjKeyBaseFileProtectContent, kn) {
					currentKey = ffjtBaseFileProtectContent
					state = fflib.FFParse_want_colon
					goto mainparse
				}
		...
		case fflib.FFParse_want_value:
			...
			if tok == fflib.FFTok_left_brace || tok == fflib.FFTok_left_bracket || tok == fflib.FFTok_integer || tok == fflib.FFTok_double || tok == fflib.FFTok_string || tok == fflib.FFTok_bool || tok == fflib.FFTok_null {
				...
				case ffjtBaseFileProtectContent:
					goto handle_ProtectContent

				case ffjtBaseFileMessageThreadID:
					goto handle_MessageThreadID

				case ffjtBaseFileMessageEffectID:
					goto handle_MessageEffectID

				case ffjtBaseFileAllowPaidBroadcast:
					goto handle_AllowPaidBroadcast

				case ffjtBaseFileReplyParameters:
					goto handle_ReplyParameters
...
const (
	...
	ffjtChatActionConfigProtectContent

	ffjtChatActionConfigMessageThreadID

	ffjtChatActionConfigMessageEffectID

	ffjtChatActionConfigAllowPaidBroadcast

	ffjtChatActionConfigReplyParameters
)
...
var ffjKeyChatActionConfigProtectContent = []byte("protect_content")

var ffjKeyChatActionConfigMessageThreadID = []byte("message_thread_id")

var ffjKeyChatActionConfigMessageEffectID = []byte("message_effect_id")

var ffjKeyChatActionConfigAllowPaidBroadcast = []byte("allow_paid_broadcast")

var ffjKeyChatActionConfigReplyParameters = []byte("reply_parameters")
	...
	for {
		...
		case fflib.FFParse_want_key:
			...
			if len(kn) <= 0 {
				...
				case 'a':
					...
					if bytes.Equal(ffjKeyChatActionConfigAllowPaidBroadcast, kn) {
						currentKey = ffjtChatActionConfigAllowPaidBroadcast
						state = fflib.FFParse_want_colon
						goto mainparse
					}
				...
				case 'm':
					...
					if bytes.Equal(ffjKeyChatActionConfigMessageThreadID, kn) {
						currentKey = ffjtChatActionConfigMessageThreadID
						state = fflib.FFParse_want_colon
						goto mainparse

					} else if bytes.Equal(ffjKeyChatActionConfigMessageEffectID, kn) {
						currentKey = ffjtChatActionConfigMessageEffectID
						state = fflib.FFParse_want_colon
						goto mainparse
					}
				...
				case 'p':
					...
					if bytes.Equal(ffjKeyChatActionConfigProtectContent, kn) {
						currentKey = ffjtChatActionConfigProtectContent
						state = fflib.FFParse_want_colon
						goto mainparse
					}
				...
				case 'r':
					...
					} else if bytes.Equal(ffjKeyChatActionConfigReplyParameters, kn) {
						currentKey = ffjtChatActionConfigReplyParameters
						state = fflib.FFParse_want_colon
						goto mainparse
					}
				...
				if fflib.EqualFoldRight(ffjKeyChatActionConfigReplyParameters, kn) {
					currentKey = ffjtChatActionConfigReplyParameters
					state = fflib.FFParse_want_colon
					goto mainparse
				}

				if fflib.EqualFoldRight(ffjKeyChatActionConfigAllowPaidBroadcast, kn) {
					currentKey = ffjtChatActionConfigAllowPaidBroadcast
					state = fflib.FFParse_want_colon
					goto mainparse
				}

				if fflib.EqualFoldRight(ffjKeyChatActionConfigMessageEffectID, kn) {
					currentKey = ffjtChatActionConfigMessageEffectID
					state = fflib.FFParse_want_colon
					goto mainparse
				}

				if fflib.EqualFoldRight(ffjKeyChatActionConfigMessageThreadID, kn) {
					currentKey = ffjtChatActionConfigMessageThreadID
					state = fflib.FFParse_want_colon
					goto mainparse
				}

				if fflib.AsciiEqualFold(ffjKeyChatActionConfigProtectContent, kn) {
					currentKey = ffjtChatActionConfigProtectContent
					state = fflib.FFParse_want_colon
					goto mainparse
				}
		...
		case fflib.FFParse_want_value:
			...
			if tok == fflib.FFTok_left_brace || tok == fflib.FFTok_left_bracket || tok == fflib.FFTok_integer || tok == fflib.FFTok_double || tok == fflib.FFTok_string || tok == fflib.FFTok_bool || tok == fflib.FFTok_null {
				...
				case ffjtChatActionConfigProtectContent:
					goto handle_ProtectContent

				case ffjtChatActionConfigMessageThreadID:
					goto handle_MessageThreadID

				case ffjtChatActionConfigMessageEffectID:
					goto handle_MessageEffectID

				case ffjtChatActionConfigAllowPaidBroadcast:
					goto handle_AllowPaidBroadcast

				case ffjtChatActionConfigReplyParameters:
					goto handle_ReplyParameters
...
const (
	...
	ffjtContactConfigProtectContent

	ffjtContactConfigMessageThreadID

	ffjtContactConfigMessageEffectID

	ffjtContactConfigAllowPaidBroadcast

	ffjtContactConfigReplyParameters
)
...
var ffjKeyContactConfigProtectContent = []byte("protect_content")

var ffjKeyContactConfigMessageThreadID = []byte("message_thread_id")

var ffjKeyContactConfigMessageEffectID = []byte("message_effect_id")

var ffjKeyContactConfigAllowPaidBroadcast = []byte("allow_paid_broadcast")

var ffjKeyContactConfigReplyParameters = []byte("reply_parameters")
	...
	for {
		...
		case fflib.FFParse_want_key:
			...
			if len(kn) <= 0 {
				...
				case 'a':
					...
					if bytes.Equal(ffjKeyContactConfigAllowPaidBroadcast, kn) {
						currentKey = ffjtContactConfigAllowPaidBroadcast
						state = fflib.FFParse_want_colon
						goto mainparse
					}
				...
				case 'm':
					...
					if bytes.Equal(ffjKeyContactConfigMessageThreadID, kn) {
						currentKey = ffjtContactConfigMessageThreadID
						state = fflib.FFParse_want_colon
						goto mainparse

					} else if bytes.Equal(ffjKeyContactConfigMessageEffectID, kn) {
						currentKey = ffjtContactConfigMessageEffectID
						state = fflib.FFParse_want_colon
						goto mainparse
					}
				...
				case 'p':
					...
					if bytes.Equal(ffjKeyContactConfigProtectContent, kn) {
						currentKey = ffjtContactConfigProtectContent
						state = fflib.FFParse_want_colon
						goto mainparse
					}
				...
				case 'r':
					...
					} else if bytes.Equal(ffjKeyContactConfigReplyParameters, kn) {
						currentKey = ffjtContactConfigReplyParameters
						state = fflib.FFParse_want_colon
						goto mainparse
					}
				...
				if fflib.EqualFoldRight(ffjKeyContactConfigReplyParameters, kn) {
					currentKey = ffjtContactConfigReplyParameters
					state = fflib.FFParse_want_colon
					goto mainparse
				}

				if fflib.EqualFoldRight(ffjKeyContactConfigAllowPaidBroadcast, kn) {
					currentKey = ffjtContactConfigAllowPaidBroadcast
					state = fflib.FFParse_want_colon
					goto mainparse
				}

				if fflib.EqualFoldRight(ffjKeyContactConfigMessageEffectID, kn) {
					currentKey = ffjtContactConfigMessageEffectID
					state = fflib.FFParse_want_colon
					goto mainparse
				}

				if fflib.EqualFoldRight(ffjKeyContactConfigMessageThreadID, kn) {
					currentKey = ffjtContactConfigMessageThreadID
					state = fflib.FFParse_want_colon
					goto mainparse
				}

				if fflib.AsciiEqualFold(ffjKeyContactConfigProtectContent, kn) {
					currentKey = ffjtContactConfigProtectContent
					state = fflib.FFParse_want_colon
					goto mainparse
				}
		...
		case fflib.FFParse_want_value:
			...
			if tok == fflib.FFTok_left_brace || tok == fflib.FFTok_left_bracket || tok == fflib.FFTok_integer || tok == fflib.FFTok_double || tok == fflib.FFTok_string || tok == fflib.FFTok_bool || tok == fflib.FFTok_null {
				...
				case ffjtContactConfigProtectContent:
					goto handle_ProtectContent

				case ffjtContactConfigMessageThreadID:
					goto handle_MessageThreadID

				case ffjtContactConfigMessageEffectID:
					goto handle_MessageEffectID

				case ffjtContactConfigAllowPaidBroadcast:
					goto handle_AllowPaidBroadcast

				case ffjtContactConfigReplyParameters:
					goto handle_ReplyParameters
...
const (
	...
	ffjtDocumentConfigProtectContent

	ffjtDocumentConfigMessageThreadID

	ffjtDocumentConfigMessageEffectID

	ffjtDocumentConfigAllowPaidBroadcast

	ffjtDocumentConfigReplyParameters
)
...
var ffjKeyDocumentConfigProtectContent = []byte("protect_content")

var ffjKeyDocumentConfigMessageThreadID = []byte("message_thread_id")

var ffjKeyDocumentConfigMessageEffectID = []byte("message_effect_id")

var ffjKeyDocumentConfigAllowPaidBroadcast = []byte("allow_paid_broadcast")

var ffjKeyDocumentConfigReplyParameters = []byte("reply_parameters")
	...
	for {
		...
		case fflib.FFParse_want_key:
			...
			if len(kn) <= 0 {
				...
				case 'a':
					...
					if bytes.Equal(ffjKeyDocumentConfigAllowPaidBroadcast, kn) {
						currentKey = ffjtDocumentConfigAllowPaidBroadcast
						state = fflib.FFParse_want_colon
						goto mainparse
					}
				...
				case 'm':
					...
					if bytes.Equal(ffjKeyDocumentConfigMessageThreadID, kn) {
						currentKey = ffjtDocumentConfigMessageThreadID
						state = fflib.FFParse_want_colon
						goto mainparse

					} else if bytes.Equal(ffjKeyDocumentConfigMessageEffectID, kn) {
						currentKey = ffjtDocumentConfigMessageEffectID
						state = fflib.FFParse_want_colon
						goto mainparse
					}
				...
				case 'p':
					...
					if bytes.Equal(ffjKeyDocumentConfigProtectContent, kn) {
						currentKey = ffjtDocumentConfigProtectContent
						state = fflib.FFParse_want_colon
						goto mainparse
					}
				...
				case 'r':
					...
					} else if bytes.Equal(ffjKeyDocumentConfigReplyParameters, kn) {
						currentKey = ffjtDocumentConfigReplyParameters
						state = fflib.FFParse_want_colon
						goto mainparse
					}
				...
				if fflib.EqualFoldRight(ffjKeyDocumentConfigReplyParameters, kn) {
					currentKey = ffjtDocumentConfigReplyParameters
					state = fflib.FFParse_want_colon
					goto mainparse
				}

				if fflib.EqualFoldRight(ffjKeyDocumentConfigAllowPaidBroadcast, kn) {
					currentKey = ffjtDocumentConfigAllowPaidBroadcast
					state = fflib.FFParse_want_colon
					goto mainparse
				}

				if fflib.EqualFoldRight(ffjKeyDocumentConfigMessageEffectID, kn) {
					currentKey = ffjtDocumentConfigMessageEffectID
					state = fflib.FFParse_want_colon
					goto mainparse
				}

				if fflib.EqualFoldRight(ffjKeyDocumentConfigMessageThreadID, kn) {
					currentKey = ffjtDocumentConfigMessageThreadID
					state = fflib.FFParse_want_colon
					goto mainparse
				}

				if fflib.AsciiEqualFold(ffjKeyDocumentConfigProtectContent, kn) {
					currentKey = ffjtDocumentConfigProtectContent
					state = fflib.FFParse_want_colon
					goto mainparse
				}
		...
		case fflib.FFParse_want_value:
			...
			if tok == fflib.FFTok_left_brace || tok == fflib.FFTok_left_bracket || tok == fflib.FFTok_integer || tok == fflib.FFTok_double || tok == fflib.FFTok_string || tok == fflib.FFTok_bool || tok == fflib.FFTok_null {
				...
				case ffjtDocumentConfigProtectContent:
					goto handle_ProtectContent

				case ffjtDocumentConfigMessageThreadID:
					goto handle_MessageThreadID

				case ffjtDocumentConfigMessageEffectID:
					goto handle_MessageEffectID

				case ffjtDocumentConfigAllowPaidBroadcast:
					goto handle_AllowPaidBroadcast

				case ffjtDocumentConfigReplyParameters:
					goto handle_ReplyParameters
...
const (
	...
	ffjtForwardConfigProtectContent

	ffjtForwardConfigMessageThreadID

	ffjtForwardConfigMessageEffectID

	ffjtForwardConfigAllowPaidBroadcast

	ffjtForwardConfigReplyParameters
)
...
var ffjKeyForwardConfigProtectContent = []byte("protect_content")

var ffjKeyForwardConfigMessageThreadID = []byte("message_thread_id")

var ffjKeyForwardConfigMessageEffectID = []byte("message_effect_id")

var ffjKeyForwardConfigAllowPaidBroadcast = []byte("allow_paid_broadcast")

var ffjKeyForwardConfigReplyParameters = []byte("reply_parameters")
	...
	for {
		...
		case fflib.FFParse_want_key:
			...
			if len(kn) <= 0 {
				...
				case 'a':
					...
					if bytes.Equal(ffjKeyForwardConfigAllowPaidBroadcast, kn) {
						currentKey = ffjtForwardConfigAllowPaidBroadcast
						state = fflib.FFParse_want_colon
						goto mainparse
					}
				...
				case 'm':
					...
					if bytes.Equal(ffjKeyForwardConfigMessageThreadID, kn) {
						currentKey = ffjtForwardConfigMessageThreadID
						state = fflib.FFParse_want_colon
						goto mainparse

					} else if bytes.Equal(ffjKeyForwardConfigMessageEffectID, kn) {
						currentKey = ffjtForwardConfigMessageEffectID
						state = fflib.FFParse_want_colon
						goto mainparse
					}
				...
				case 'p':
					...
					if bytes.Equal(ffjKeyForwardConfigProtectContent, kn) {
						currentKey = ffjtForwardConfigProtectContent
						state = fflib.FFParse_want_colon
						goto mainparse
					}
				...
				case 'r':
					...
					} else if bytes.Equal(ffjKeyForwardConfigReplyParameters, kn) {
						currentKey = ffjtForwardConfigReplyParameters
						state = fflib.FFParse_want_colon
						goto mainparse
					}
				...
				if fflib.EqualFoldRight(ffjKeyForwardConfigReplyParameters, kn) {
					currentKey = ffjtForwardConfigReplyParameters
					state = fflib.FFParse_want_colon
					goto mainparse
				}

				if fflib.EqualFoldRight(ffjKeyForwardConfigAllowPaidBroadcast, kn) {
					currentKey = ffjtForwardConfigAllowPaidBroadcast
					state = fflib.FFParse_want_colon
					goto mainparse
				}

				if fflib.EqualFoldRight(ffjKeyForwardConfigMessageEffectID, kn) {
					currentKey = ffjtForwardConfigMessageEffectID
					state = fflib.FFParse_want_colon
					goto mainparse
				}

				if fflib.EqualFoldRight(ffjKeyForwardConfigMessageThreadID, kn) {
					currentKey = ffjtForwardConfigMessageThreadID
					state = fflib.FFParse_want_colon
					goto mainparse
				}

				if fflib.AsciiEqualFold(ffjKeyForwardConfigProtectContent, kn) {
					currentKey = ffjtForwardConfigProtectContent
					state = fflib.FFParse_want_colon
					goto mainparse
				}
		...
		case fflib.FFParse_want_value:
			...
			if tok == fflib.FFTok_left_brace || tok == fflib.FFTok_left_bracket || tok == fflib.FFTok_integer || tok == fflib.FFTok_double || tok == fflib.FFTok_string || tok == fflib.FFTok_bool || tok == fflib.FFTok_null {
				...
				case ffjtForwardConfigProtectContent:
					goto handle_ProtectContent

				case ffjtForwardConfigMessageThreadID:
					goto handle_MessageThreadID

				case ffjtForwardConfigMessageEffectID:
					goto handle_MessageEffectID

				case ffjtForwardConfigAllowPaidBroadcast:
					goto handle_AllowPaidBroadcast

				case ffjtForwardConfigReplyParameters:
					goto handle_ReplyParameters
...
const (
	...
	ffjtLocationConfigProtectContent

	ffjtLocationConfigMessageThreadID

	ffjtLocationConfigMessageEffectID

	ffjtLocationConfigAllowPaidBroadcast

	ffjtLocationConfigReplyParameters
)
...
var ffjKeyLocationConfigProtectContent = []byte("protect_content")

var ffjKeyLocationConfigMessageThreadID = []byte("message_thread_id")

var ffjKeyLocationConfigMessageEffectID = []byte("message_effect_id")

var ffjKeyLocationConfigAllowPaidBroadcast = []byte("allow_paid_broadcast")

var ffjKeyLocationConfigReplyParameters = []byte("reply_parameters")
	...
	for {
		...
		case fflib.FFParse_want_key:
			...
			if len(kn) <= 0 {
				...
				case 'a':
					...
					if bytes.Equal(ffjKeyLocationConfigAllowPaidBroadcast, kn) {
						currentKey = ffjtLocationConfigAllowPaidBroadcast
						state = fflib.FFParse_want_colon
						goto mainparse
					}
				...
				case 'm':
					...
					if bytes.Equal(ffjKeyLocationConfigMessageThreadID, kn) {
						currentKey = ffjtLocationConfigMessageThreadID
						state = fflib.FFParse_want_colon
						goto mainparse

					} else if bytes.Equal(ffjKeyLocationConfigMessageEffectID, kn) {
						currentKey = ffjtLocationConfigMessageEffectID
						state = fflib.FFParse_want_colon
						goto mainparse
					}
				...
				case 'p':
					...
					if bytes.Equal(ffjKeyLocationConfigProtectContent, kn) {
						currentKey = ffjtLocationConfigProtectContent
						state = fflib.FFParse_want_colon
						goto mainparse
					}
				...
				case 'r':
					...
					} else if bytes.Equal(ffjKeyLocationConfigReplyParameters, kn) {
						currentKey = ffjtLocationConfigReplyParameters
						state = fflib.FFParse_want_colon
						goto mainparse
					}
				...
				if fflib.EqualFoldRight(ffjKeyLocationConfigReplyParameters, kn) {
					currentKey = ffjtLocationConfigReplyParameters
					state = fflib.FFParse_want_colon
					goto mainparse
				}

				if fflib.EqualFoldRight(ffjKeyLocationConfigAllowPaidBroadcast, kn) {
					currentKey = ffjtLocationConfigAllowPaidBroadcast
					state = fflib.FFParse_want_colon
					goto mainparse
				}

				if fflib.EqualFoldRight(ffjKeyLocationConfigMessageEffectID, kn) {
					currentKey = ffjtLocationConfigMessageEffectID
					state = fflib.FFParse_want_colon
					goto mainparse
				}

				if fflib.EqualFoldRight(ffjKeyLocationConfigMessageThreadID, kn) {
					currentKey = ffjtLocationConfigMessageThreadID
					state = fflib.FFParse_want_colon
					goto mainparse
				}

				if fflib.AsciiEqualFold(ffjKeyLocationConfigProtectContent, kn) {
					currentKey = ffjtLocationConfigProtectContent
					state = fflib.FFParse_want_colon
					goto mainparse
				}
		...
		case fflib.FFParse_want_value:
			...
			if tok == fflib.FFTok_left_brace || tok == fflib.FFTok_left_bracket || tok == fflib.FFTok_integer || tok == fflib.FFTok_double || tok == fflib.FFTok_string || tok == fflib.FFTok_bool || tok == fflib.FFTok_null {
				...
				case ffjtLocationConfigProtectContent:
					goto handle_ProtectContent

				case ffjtLocationConfigMessageThreadID:
					goto handle_MessageThreadID

				case ffjtLocationConfigMessageEffectID:
					goto handle_MessageEffectID

				case ffjtLocationConfigAllowPaidBroadcast:
					goto handle_AllowPaidBroadcast

				case ffjtLocationConfigReplyParameters:
					goto handle_ReplyParameters
...
const (
	...
	ffjtMessageConfigProtectContent

	ffjtMessageConfigMessageThreadID

	ffjtMessageConfigMessageEffectID

	ffjtMessageConfigAllowPaidBroadcast

	ffjtMessageConfigReplyParameters
)
...
var ffjKeyMessageConfigProtectContent = []byte("protect_content")

var ffjKeyMessageConfigMessageThreadID = []byte("message_thread_id")

var ffjKeyMessageConfigMessageEffectID = []byte("message_effect_id")

var ffjKeyMessageConfigAllowPaidBroadcast = []byte("allow_paid_broadcast")

var ffjKeyMessageConfigReplyParameters = []byte("reply_parameters")
	...
	for {
		...
		case fflib.FFParse_want_key:
			...
			if len(kn) <= 0 {
				...
				case 'a':
					...
					if bytes.Equal(ffjKeyMessageConfigAllowPaidBroadcast, kn) {
						currentKey = ffjtMessageConfigAllowPaidBroadcast
						state = fflib.FFParse_want_colon
						goto mainparse
					}
				...
				case 'm':
					...
					if bytes.Equal(ffjKeyMessageConfigMessageThreadID, kn) {
						currentKey = ffjtMessageConfigMessageThreadID
						state = fflib.FFParse_want_colon
						goto mainparse

					} else if bytes.Equal(ffjKeyMessageConfigMessageEffectID, kn) {
						currentKey = ffjtMessageConfigMessageEffectID
						state = fflib.FFParse_want_colon
						goto mainparse
					}
				...
				case 'p':
					...
					} else if bytes.Equal(ffjKeyMessageConfigProtectContent, kn) {
						currentKey = ffjtMessageConfigProtectContent
						state = fflib.FFParse_want_colon
						goto mainparse
					}
				...
				case 'r':
					...
					} else if bytes.Equal(ffjKeyMessageConfigReplyParameters, kn) {
						currentKey = ffjtMessageConfigReplyParameters
						state = fflib.FFParse_want_colon
						goto mainparse
					}
				...
				if fflib.EqualFoldRight(ffjKeyMessageConfigReplyParameters, kn) {
					currentKey = ffjtMessageConfigReplyParameters
					state = fflib.FFParse_want_colon
					goto mainparse
				}

				if fflib.EqualFoldRight(ffjKeyMessageConfigAllowPaidBroadcast, kn) {
					currentKey = ffjtMessageConfigAllowPaidBroadcast
					state = fflib.FFParse_want_colon
					goto mainparse
				}

				if fflib.EqualFoldRight(ffjKeyMessageConfigMessageEffectID, kn) {
					currentKey = ffjtMessageConfigMessageEffectID
					state = fflib.FFParse_want_colon
					goto mainparse
				}

				if fflib.EqualFoldRight(ffjKeyMessageConfigMessageThreadID, kn) {
					currentKey = ffjtMessageConfigMessageThreadID
					state = fflib.FFParse_want_colon
					goto mainparse
				}

				if fflib.AsciiEqualFold(ffjKeyMessageConfigProtectContent, kn) {
					currentKey = ffjtMessageConfigProtectContent
					state = fflib.FFParse_want_colon
					goto mainparse
				}
		...
		case fflib.FFParse_want_value:
			...
			if tok == fflib.FFTok_left_brace || tok == fflib.FFTok_left_bracket || tok == fflib.FFTok_integer || tok == fflib.FFTok_double || tok == fflib.FFTok_string || tok == fflib.FFTok_bool || tok == fflib.FFTok_null {
				...
				case ffjtMessageConfigProtectContent:
					goto handle_ProtectContent

				case ffjtMessageConfigMessageThreadID:
					goto handle_MessageThreadID

				case ffjtMessageConfigMessageEffectID:
					goto handle_MessageEffectID

				case ffjtMessageConfigAllowPaidBroadcast:
					goto handle_AllowPaidBroadcast

				case ffjtMessageConfigReplyParameters:
					goto handle_ReplyParameters
...
const (
	...
	ffjtPhotoConfigProtectContent

	ffjtPhotoConfigMessageThreadID

	ffjtPhotoConfigMessageEffectID

	ffjtPhotoConfigAllowPaidBroadcast

	ffjtPhotoConfigReplyParameters
)
...
var ffjKeyPhotoConfigProtectContent = []byte("protect_content")

var ffjKeyPhotoConfigMessageThreadID = []byte("message_thread_id")

var ffjKeyPhotoConfigMessageEffectID = []byte("message_effect_id")

var ffjKeyPhotoConfigAllowPaidBroadcast = []byte("allow_paid_broadcast")

var ffjKeyPhotoConfigReplyParameters = []byte("reply_parameters")
	...
	for {
		...
		case fflib.FFParse_want_key:
			...
			if len(kn) <= 0 {
				...
				case 'a':
					...
					if bytes.Equal(ffjKeyPhotoConfigAllowPaidBroadcast, kn) {
						currentKey = ffjtPhotoConfigAllowPaidBroadcast
						state = fflib.FFParse_want_colon
						goto mainparse
					}
				...
				case 'm':
					...
					if bytes.Equal(ffjKeyPhotoConfigMessageThreadID, kn) {
						currentKey = ffjtPhotoConfigMessageThreadID
						state = fflib.FFParse_want_colon
						goto mainparse

					} else if bytes.Equal(ffjKeyPhotoConfigMessageEffectID, kn) {
						currentKey = ffjtPhotoConfigMessageEffectID
						state = fflib.FFParse_want_colon
						goto mainparse
					}
				...
				case 'p':
					...
					if bytes.Equal(ffjKeyPhotoConfigProtectContent, kn) {
						currentKey = ffjtPhotoConfigProtectContent
						state = fflib.FFParse_want_colon
						goto mainparse
					}
				...
				case 'r':
					...
					} else if bytes.Equal(ffjKeyPhotoConfigReplyParameters, kn) {
						currentKey = ffjtPhotoConfigReplyParameters
						state = fflib.FFParse_want_colon
						goto mainparse
					}
				...
				if fflib.EqualFoldRight(ffjKeyPhotoConfigReplyParameters, kn) {
					currentKey = ffjtPhotoConfigReplyParameters
					state = fflib.FFParse_want_colon
					goto mainparse
				}

				if fflib.EqualFoldRight(ffjKeyPhotoConfigAllowPaidBroadcast, kn) {
					currentKey = ffjtPhotoConfigAllowPaidBroadcast
					state = fflib.FFParse_want_colon
					goto mainparse
				}

				if fflib.EqualFoldRight(ffjKeyPhotoConfigMessageEffectID, kn) {
					currentKey = ffjtPhotoConfigMessageEffectID
					state = fflib.FFParse_want_colon
					goto mainparse
				}

				if fflib.EqualFoldRight(ffjKeyPhotoConfigMessageThreadID, kn) {
					currentKey = ffjtPhotoConfigMessageThreadID
					state = fflib.FFParse_want_colon
					goto mainparse
				}

				if fflib.AsciiEqualFold(ffjKeyPhotoConfigProtectContent, kn) {
					currentKey = ffjtPhotoConfigProtectContent
					state = fflib.FFParse_want_colon
					goto mainparse
				}
		...
		case fflib.FFParse_want_value:
			...
			if tok == fflib.FFTok_left_brace || tok == fflib.FFTok_left_bracket || tok == fflib.FFTok_integer || tok == fflib.FFTok_double || tok == fflib.FFTok_string || tok == fflib.FFTok_bool || tok == fflib.FFTok_null {
				...
				case ffjtPhotoConfigProtectContent:
					goto handle_ProtectContent

				case ffjtPhotoConfigMessageThreadID:
					goto handle_MessageThreadID

				case ffjtPhotoConfigMessageEffectID:
					goto handle_MessageEffectID

				case ffjtPhotoConfigAllowPaidBroadcast:
					goto handle_AllowPaidBroadcast

				case ffjtPhotoConfigReplyParameters:
					goto handle_ReplyParameters
...
const (
	...
	ffjtStickerConfigProtectContent

	ffjtStickerConfigMessageThreadID

	ffjtStickerConfigMessageEffectID

	ffjtStickerConfigAllowPaidBroadcast

	ffjtStickerConfigReplyParameters
)
...
var ffjKeyStickerConfigProtectContent = []byte("protect_content")

var ffjKeyStickerConfigMessageThreadID = []byte("message_thread_id")

var ffjKeyStickerConfigMessageEffectID = []byte("message_effect_id")

var ffjKeyStickerConfigAllowPaidBroadcast = []byte("allow_paid_broadcast")

var ffjKeyStickerConfigReplyParameters = []byte("reply_parameters")
	...
	for {
		...
		case fflib.FFParse_want_key:
			...
			if len(kn) <= 0 {
				...
				case 'a':
					...
					if bytes.Equal(ffjKeyStickerConfigAllowPaidBroadcast, kn) {
						currentKey = ffjtStickerConfigAllowPaidBroadcast
						state = fflib.FFParse_want_colon
						goto mainparse
					}
				...
				case 'm':
					...
					if bytes.Equal(ffjKeyStickerConfigMessageThreadID, kn) {
						currentKey = ffjtStickerConfigMessageThreadID
						state = fflib.FFParse_want_colon
						goto mainparse

					} else if bytes.Equal(ffjKeyStickerConfigMessageEffectID, kn) {
						currentKey = ffjtStickerConfigMessageEffectID
						state = fflib.FFParse_want_colon
						goto mainparse
					}
				...
				case 'p':
					...
					if bytes.Equal(ffjKeyStickerConfigProtectContent, kn) {
						currentKey = ffjtStickerConfigProtectContent
						state = fflib.FFParse_want_colon
						goto mainparse
					}
				...
				case 'r':
					...
					} else if bytes.Equal(ffjKeyStickerConfigReplyParameters, kn) {
						currentKey = ffjtStickerConfigReplyParameters
						state = fflib.FFParse_want_colon
						goto mainparse
					}
				...
				if fflib.EqualFoldRight(ffjKeyStickerConfigReplyParameters, kn) {
					currentKey = ffjtStickerConfigReplyParameters
					state = fflib.FFParse_want_colon
					goto mainparse
				}

				if fflib.EqualFoldRight(ffjKeyStickerConfigAllowPaidBroadcast, kn) {
					currentKey = ffjtStickerConfigAllowPaidBroadcast
					state = fflib.FFParse_want_colon
					goto mainparse
				}

				if fflib.EqualFoldRight(ffjKeyStickerConfigMessageEffectID, kn) {
					currentKey = ffjtStickerConfigMessageEffectID
					state = fflib.FFParse_want_colon
					goto mainparse
				}

				if fflib.EqualFoldRight(ffjKeyStickerConfigMessageThreadID, kn) {
					currentKey = ffjtStickerConfigMessageThreadID
					state = fflib.FFParse_want_colon
					goto mainparse
				}

				if fflib.AsciiEqualFold(ffjKeyStickerConfigProtectContent, kn) {
					currentKey = ffjtStickerConfigProtectContent
					state = fflib.FFParse_want_colon
					goto mainparse
				}
		...
		case fflib.FFParse_want_value:
			...
			if tok == fflib.FFTok_left_brace || tok == fflib.FFTok_left_bracket || tok == fflib.FFTok_integer || tok == fflib.FFTok_double || tok == fflib.FFTok_string || tok == fflib.FFTok_bool || tok == fflib.FFTok_null {
				...
				case ffjtStickerConfigProtectContent:
					goto handle_ProtectContent

				case ffjtStickerConfigMessageThreadID:
					goto handle_MessageThreadID

				case ffjtStickerConfigMessageEffectID:
					goto handle_MessageEffectID

				case ffjtStickerConfigAllowPaidBroadcast:
					goto handle_AllowPaidBroadcast

				case ffjtStickerConfigReplyParameters:
					goto handle_ReplyParameters
...
const (
	...
	ffjtVenueConfigProtectContent

	ffjtVenueConfigMessageThreadID

	ffjtVenueConfigMessageEffectID

	ffjtVenueConfigAllowPaidBroadcast

	ffjtVenueConfigReplyParameters
)
...
var ffjKeyVenueConfigProtectContent = []byte("protect_content")

var ffjKeyVenueConfigMessageThreadID = []byte("message_thread_id")

var ffjKeyVenueConfigMessageEffectID = []byte("message_effect_id")

var ffjKeyVenueConfigAllowPaidBroadcast = []byte("allow_paid_broadcast")

var ffjKeyVenueConfigReplyParameters = []byte("reply_parameters")
	...
	for {
		...
		case fflib.FFParse_want_key:
			...
			if len(kn) <= 0 {
				...
				case 'a':
					...
					if bytes.Equal(ffjKeyVenueConfigAllowPaidBroadcast, kn) {
						currentKey = ffjtVenueConfigAllowPaidBroadcast
						state = fflib.FFParse_want_colon
						goto mainparse
					}
				...
				case 'm':
					...
					if bytes.Equal(ffjKeyVenueConfigMessageThreadID, kn) {
						currentKey = ffjtVenueConfigMessageThreadID
						state = fflib.FFParse_want_colon
						goto mainparse

					} else if bytes.Equal(ffjKeyVenueConfigMessageEffectID, kn) {
						currentKey = ffjtVenueConfigMessageEffectID
						state = fflib.FFParse_want_colon
						goto mainparse
					}
				...
				case 'p':
					...
					if bytes.Equal(ffjKeyVenueConfigProtectContent, kn) {
						currentKey = ffjtVenueConfigProtectContent
						state = fflib.FFParse_want_colon
						goto mainparse
					}
				...
				case 'r':
					...
					} else if bytes.Equal(ffjKeyVenueConfigReplyParameters, kn) {
						currentKey = ffjtVenueConfigReplyParameters
						state = fflib.FFParse_want_colon
						goto mainparse
					}
				...
				if fflib.EqualFoldRight(ffjKeyVenueConfigReplyParameters, kn) {
					currentKey = ffjtVenueConfigReplyParameters
					state = fflib.FFParse_want_colon
					goto mainparse
				}

				if fflib.EqualFoldRight(ffjKeyVenueConfigAllowPaidBroadcast, kn) {
					currentKey = ffjtVenueConfigAllowPaidBroadcast
					state = fflib.FFParse_want_colon
					goto mainparse
				}

				if fflib.EqualFoldRight(ffjKeyVenueConfigMessageEffectID, kn) {
					currentKey = ffjtVenueConfigMessageEffectID
					state = fflib.FFParse_want_colon
					goto mainparse
				}

				if fflib.EqualFoldRight(ffjKeyVenueConfigMessageThreadID, kn) {
					currentKey = ffjtVenueConfigMessageThreadID
					state = fflib.FFParse_want_colon
					goto mainparse
				}

				if fflib.AsciiEqualFold(ffjKeyVenueConfigProtectContent, kn) {
					currentKey = ffjtVenueConfigProtectContent
					state = fflib.FFParse_want_colon
					goto mainparse
				}
		...
		case fflib.FFParse_want_value:
			...
			if tok == fflib.FFTok_left_brace || tok == fflib.FFTok_left_bracket || tok == fflib.FFTok_integer || tok == fflib.FFTok_double || tok == fflib.FFTok_string || tok == fflib.FFTok_bool || tok == fflib.FFTok_null {
				...
				case ffjtVenueConfigProtectContent:
					goto handle_ProtectContent

				case ffjtVenueConfigMessageThreadID:
					goto handle_MessageThreadID

				case ffjtVenueConfigMessageEffectID:
					goto handle_MessageEffectID

				case ffjtVenueConfigAllowPaidBroadcast:
					goto handle_AllowPaidBroadcast

				case ffjtVenueConfigReplyParameters:
					goto handle_ReplyParameters
...
const (
	...
	ffjtVideoConfigProtectContent

	ffjtVideoConfigMessageThreadID

	ffjtVideoConfigMessageEffectID

	ffjtVideoConfigAllowPaidBroadcast

	ffjtVideoConfigReplyParameters
)
...
var ffjKeyVideoConfigProtectContent = []byte("protect_content")

var ffjKeyVideoConfigMessageThreadID = []byte("message_thread_id")

var ffjKeyVideoConfigMessageEffectID = []byte("message_effect_id")

var ffjKeyVideoConfigAllowPaidBroadcast = []byte("allow_paid_broadcast")

var ffjKeyVideoConfigReplyParameters = []byte("reply_parameters")
	...
	for {
		...
		case fflib.FFParse_want_key:
			...
			if len(kn) <= 0 {
				...
				case 'a':
					...
					if bytes.Equal(ffjKeyVideoConfigAllowPaidBroadcast, kn) {
						currentKey = ffjtVideoConfigAllowPaidBroadcast
						state = fflib.FFParse_want_colon
						goto mainparse
					}
				...
				case 'm':
					...
					if bytes.Equal(ffjKeyVideoConfigMessageThreadID, kn) {
						currentKey = ffjtVideoConfigMessageThreadID
						state = fflib.FFParse_want_colon
						goto mainparse

					} else if bytes.Equal(ffjKeyVideoConfigMessageEffectID, kn) {
						currentKey = ffjtVideoConfigMessageEffectID
						state = fflib.FFParse_want_colon
						goto mainparse
					}
				...
				case 'p':
					...
					if bytes.Equal(ffjKeyVideoConfigProtectContent, kn) {
						currentKey = ffjtVideoConfigProtectContent
						state = fflib.FFParse_want_colon
						goto mainparse
					}
				...
				case 'r':
					...
					} else if bytes.Equal(ffjKeyVideoConfigReplyParameters, kn) {
						currentKey = ffjtVideoConfigReplyParameters
						state = fflib.FFParse_want_colon
						goto mainparse
					}
				...
				if fflib.EqualFoldRight(ffjKeyVideoConfigReplyParameters, kn) {
					currentKey = ffjtVideoConfigReplyParameters
					state = fflib.FFParse_want_colon
					goto mainparse
				}

				if fflib.EqualFoldRight(ffjKeyVideoConfigAllowPaidBroadcast, kn) {
					currentKey = ffjtVideoConfigAllowPaidBroadcast
					state = fflib.FFParse_want_colon
					goto mainparse
				}

				if fflib.EqualFoldRight(ffjKeyVideoConfigMessageEffectID, kn) {
					currentKey = ffjtVideoConfigMessageEffectID
					state = fflib.FFParse_want_colon
					goto mainparse
				}

				if fflib.EqualFoldRight(ffjKeyVideoConfigMessageThreadID, kn) {
					currentKey = ffjtVideoConfigMessageThreadID
					state = fflib.FFParse_want_colon
					goto mainparse
				}

				if fflib.AsciiEqualFold(ffjKeyVideoConfigProtectContent, kn) {
					currentKey = ffjtVideoConfigProtectContent
					state = fflib.FFParse_want_colon
					goto mainparse
				}
		...
		case fflib.FFParse_want_value:
			...
			if tok == fflib.FFTok_left_brace || tok == fflib.FFTok_left_bracket || tok == fflib.FFTok_integer || tok == fflib.FFTok_double || tok == fflib.FFTok_string || tok == fflib.FFTok_bool || tok == fflib.FFTok_null {
				...
				case ffjtVideoConfigProtectContent:
					goto handle_ProtectContent

				case ffjtVideoConfigMessageThreadID:
					goto handle_MessageThreadID

				case ffjtVideoConfigMessageEffectID:
					goto handle_MessageEffectID

				case ffjtVideoConfigAllowPaidBroadcast:
					goto handle_AllowPaidBroadcast

				case ffjtVideoConfigReplyParameters:
					goto handle_ReplyParameters
...
const (
	...
	ffjtVoiceConfigProtectContent

	ffjtVoiceConfigMessageThreadID

	ffjtVoiceConfigMessageEffectID

	ffjtVoiceConfigAllowPaidBroadcast

	ffjtVoiceConfigReplyParameters
)
...
var ffjKeyVoiceConfigProtectContent = []byte("protect_content")

var ffjKeyVoiceConfigMessageThreadID = []byte("message_thread_id")

var ffjKeyVoiceConfigMessageEffectID = []byte("message_effect_id")

var ffjKeyVoiceConfigAllowPaidBroadcast = []byte("allow_paid_broadcast")

var ffjKeyVoiceConfigReplyParameters = []byte("reply_parameters")
	...
	for {
		...
		case fflib.FFParse_want_key:
			...
			if len(kn) <= 0 {
				...
				case 'a':
					...
					if bytes.Equal(ffjKeyVoiceConfigAllowPaidBroadcast, kn) {
						currentKey = ffjtVoiceConfigAllowPaidBroadcast
						state = fflib.FFParse_want_colon
						goto mainparse
					}
				...
				case 'm':
					...
					if bytes.Equal(ffjKeyVoiceConfigMessageThreadID, kn) {
						currentKey = ffjtVoiceConfigMessageThreadID
						state = fflib.FFParse_want_colon
						goto mainparse

					} else if bytes.Equal(ffjKeyVoiceConfigMessageEffectID, kn) {
						currentKey = ffjtVoiceConfigMessageEffectID
						state = fflib.FFParse_want_colon
						goto mainparse
					}
				...
				case 'p':
					...
					if bytes.Equal(ffjKeyVoiceConfigProtectContent, kn) {
						currentKey = ffjtVoiceConfigProtectContent
						state = fflib.FFParse_want_colon
						goto mainparse
					}
				...
				case 'r':
					...
					} else if bytes.Equal(ffjKeyVoiceConfigReplyParameters, kn) {
						currentKey = ffjtVoiceConfigReplyParameters
						state = fflib.FFParse_want_colon
						goto mainparse
					}
				...
				if fflib.EqualFoldRight(ffjKeyVoiceConfigReplyParameters, kn) {
					currentKey = ffjtVoiceConfigReplyParameters
					state = fflib.FFParse_want_colon
					goto mainparse
				}

				if fflib.EqualFoldRight(ffjKeyVoiceConfigAllowPaidBroadcast, kn) {
					currentKey = ffjtVoiceConfigAllowPaidBroadcast
					state = fflib.FFParse_want_colon
					goto mainparse
				}

				if fflib.EqualFoldRight(ffjKeyVoiceConfigMessageEffectID, kn) {
					currentKey = ffjtVoiceConfigMessageEffectID
					state = fflib.FFParse_want_colon
					goto mainparse
				}

				if fflib.EqualFoldRight(ffjKeyVoiceConfigMessageThreadID, kn) {
					currentKey = ffjtVoiceConfigMessageThreadID
					state = fflib.FFParse_want_colon
					goto mainparse
				}

				if fflib.AsciiEqualFold(ffjKeyVoiceConfigProtectContent, kn) {
					currentKey = ffjtVoiceConfigProtectContent
					state = fflib.FFParse_want_colon
					goto mainparse
				}
		...
		case fflib.FFParse_want_value:
			...
			if tok == fflib.FFTok_left_brace || tok == fflib.FFTok_left_bracket || tok == fflib.FFTok_integer || tok == fflib.FFTok_double || tok == fflib.FFTok_string || tok == fflib.FFTok_bool || tok == fflib.FFTok_null {
				...
				case ffjtVoiceConfigProtectContent:
					goto handle_ProtectContent

				case ffjtVoiceConfigMessageThreadID:
					goto handle_MessageThreadID

				case ffjtVoiceConfigMessageEffectID:
					goto handle_MessageEffectID

				case ffjtVoiceConfigAllowPaidBroadcast:
					goto handle_AllowPaidBroadcast

				case ffjtVoiceConfigReplyParameters:
					goto handle_ReplyParameters
